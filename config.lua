...
Config.Locations = { -- Edit the various interaction points for players or create new ones
    ...
    ["main"] = {
        [1] = vector3(331.64, -595.35, 43.28),
    },
    ["stash"] = {
        [1] = vector3(301.48, -599.03, 43.28),
    },
    ["beds"] = {
        [1] = {coords = vector4(311.17, -582.88, 44.2, 157.42), taken = false, model = 1631638868},
        [2] = {coords = vector4(314.65, -583.99, 44.2, 152.65), taken = false, model = 1631638868},
        [3] = {coords = vector4(317.63, -585.13, 44.2, 175.27), taken = false, model = 2117668672},
        [4] = {coords = vector4(322.8, -586.97, 44.2, 147.28), taken = false, model = 2117668672},
        [5] = {coords = vector4(324.17, -583.03, 44.2, 352.86), taken = false, model = 2117668672},
        [6] = {coords = vector4(319.16, -580.91, 44.2, 249.85), taken = false, model = -1091386327},
        [7] = {coords = vector4(313.66, -579.26, 44.2, 346.19), taken = false, model = -1091386327},
        [8] = {coords = vector4(309.37, -577.34, 44.2, 344.83), taken = false, model = -1091386327},
        [9] = {coords = vector4(307.9, -581.56, 44.2, 146.64), taken = false, model = -1091386327},
	--- paleto
